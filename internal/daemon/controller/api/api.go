...
type (
	...
	Service interface {
		...
		ScheduleTask(ctx context.Context, workflowRunID string, name string, input []byte) (string, error)
		SetTaskRunStatus(ctx context.Context, id string, status task.Status, output []byte) error
		GetTaskRun(ctx context.Context, id string) (task.Run, error)
		ScheduleWorkflow(ctx context.Context, parentWorkflowRunID string, name string, input []byte) (string, error)
		SetWorkflowRunStatus(ctx context.Context, id string, status workflow.Status, output []byte) error
